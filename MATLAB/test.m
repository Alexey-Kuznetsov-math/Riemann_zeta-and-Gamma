...
disp('~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~')
disp('Test 3: plot the Riemann-Siegel function Z(t) for 0<t<100, 1000<t<1100 and 10000<t<10100')
t=0:0.01:100;
...
disp(' ')
disp('Computation time (in seconds) of Riemann_zeta(s) for these 1000 random numbers s_i:')
tic
f1=Riemann_zeta(s);
T1=toc;
disp(T1);
...
disp('~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~')
disp('Test 4(b): computing the maximum relative error Riemann_zeta(s)/zeta(s)-1')
...
disp(max(abs(f1./f2-1)))
disp('~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~')
disp('Test 4(c): computing the maximum relative error Riemann_zeta(s)/zeta(s)-1')
