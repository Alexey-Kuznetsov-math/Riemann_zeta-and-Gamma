...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~    
    ...
    g(1:5)=sqrt(pi_qp)*(/1.0_qp,0.5_qp,0.75_qp,1.875_qp,6.5625_qp/)
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~    
    ...
    print *, 'psi(1)=',psi(1.0_qp+0*i_qp)
    print *, 'error=',psi(1.0_qp+0*i_qp)+0.57721566490153286060651209008240243_qp
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~    
    print *, '~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~'
...
! were downloaded from https://www-users.cse.umn.edu/~odlyzko/zeta_tables/index.html
    ...
    do k=1,5 
        print *, Riemann_zeta(0.5_qp+i_qp*t(k))
    end do
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    print *, '~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~'
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    ...
    z=0.5_qp+14.13472514173469379045725198356247027_qp*i_qp 
    s=0.5_qp+14.1_qp*i_qp
    do k=1,6
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    ...
    z=0.5_qp+401.83922860053321653991130437828723072_qp*i_qp
    s=0.5_qp+401.8_qp*i_qp  
    do k=1,6
        h=Riemann_zeta_prime(s)
        s=s-h(1)/h(2)
        print *,'next iteration of Newtons method:', s
