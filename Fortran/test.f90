...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
	implicit none		
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
	complex(kind=16)		:: z, s, f(1:10), g(1:10), w
	real(kind=16)			:: error, t(1:5)
	real				:: U(1:2)	
	integer 			:: k
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~	
	...
	g(1:5)=sqrt(pi_16)*(/1.0q0,0.5q0,0.75q0,1.875q0,6.5625q0/)
...
! were downloaded from https://www-users.cse.umn.edu/~odlyzko/zeta_tables/index.html
	...
	t(1)=14.13472514173469379045725198356247027q0
	t(2)=21.02203963877155499262847959389690277q0
	t(3)=25.01085758014568876321379099256282181q0
	t(4)=30.42487612585951321031189753058409132q0
	t(5)=32.93506158773918969066236896407490348q0
	do k=1,5 
		print *, Riemann_zeta(0.5q0+i_16*t(k))
	end do
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
	print *, '~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~'
	print *, 'Test 7 : compute zeta(1/2+i*t_k) for the first five non-trivial zeros 1/2+i*t_k of zeta(s) at height t=200'
	t(1)=201.2647519437037887330161334275481732q0
	t(2)=202.4935945141405342776866606378643158q0
	t(3)=204.1896718031045543307164383863136851q0
	t(4)=205.3946972021632860252123793906930909q0
	t(5)=207.9062588878062098615019679077536442q0
	do k=1,5 
		print *, Riemann_zeta(0.5q0+i_16*t(k))
	end do	
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
	...
	t(1)=1000000.584097696q0
	t(2)=1000000.828343490q0
	t(3)=1000001.435265267q0
	t(4)=1000001.905648406q0
	t(5)=1000002.877617740q0
	do k=1,5 
		print *, Riemann_zeta(0.5q0+i_16*t(k))
	end do		
!#######################################################################
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
	...
	elseif (abs(s)<1.0q-4) then ! use Taylor series if |s| is small
		...
		if (abs(s%im)<26.0q0) f=f*(1-exp(d*i_16*pi_16*s))
	end if	
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~	
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~	
	...
	if (s%im<26.0q0) chi=chi/(1+exp(pi_16*i_16*s))
