...
f2=zeta(s);
disp('~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~')
disp('Test (e): computing the maximum relative error Riemann_zeta_mex(s)/zeta(s)-1')
disp('for 1000 random numbers s_i, uniformly distributed in the rectangle |Im(s)|<1 000 000, -5<Re(s)<10:')
s=15*rand(1,N)-5+1000000i*(2*rand(1,N)-1);
disp(' ')
disp('Computation time (in seconds) of Riemann_zeta_mex(s) for these 1000 random numbers s_i:')
tic
f1=Riemann_zeta_mex(s);
